...
class EnemyManager extends Component with HasGameRef<KongRun> {
  ...
  void onMount() {
    ...
    if (_data.isEmpty) {
      ...
      _data.addAll([
        EnemyData(
          image: gameRef.images.fromCache('Obstacles/Pit.png'),
          nFrames: 1,
          stepTime: 0.1,
          textureSize: Vector2(50, 15),
          speedX: 80,
          canFly: false,
        ),
        EnemyData(
          image: gameRef.images.fromCache('Obstacles/bush.png'),
          nFrames: 1,
          stepTime: 0.1,
          textureSize: Vector2(59, 30),
          speedX: 80,
          canFly: false,
        ),
        EnemyData(
          image: gameRef.images.fromCache('Obstacles/Croc.png'),
          nFrames: 1,
          stepTime: 0.1,
          textureSize: Vector2(57, 30),
          speedX: 80,
          canFly: false,
        ),
        EnemyData(
        ...
        EnemyData(
          image: gameRef.images.fromCache('Rino/humanhunter.png'),
          nFrames: 6,
          stepTime: 0.15,
          textureSize: Vector2(63, 57),
          speedX: 100,
          canFly: false,
        ),
        EnemyData(
        ...
        EnemyData(
          image: gameRef.images.fromCache('Obstacles/arrow.png'),
          nFrames: 5,
          stepTime: 0.05,
          textureSize: Vector2(50, 23),
          speedX: 100,
          canFly: true,
        ),
      ]);
